...
python benchmark.py -d spouse-supervised -c configs/pca.json -g configs/top5/cdr-supervised_pca.json -E 200 > spouse-supervised_pca.log 2> spouse-supervised_pca.err
python benchmark.py -d spouse-dp -c configs/pca.json -g configs/top5/cdr-supervised_pca.json -E 200 > spouse-dp_pca.log 2> spouse-dp_pca.err
...
python benchmark.py -d spouse-supervised -c configs/pca-kernel.json -g configs/top5/cdr-supervised_pca-kernel.json -E 200 > spouse-supervised_pca-kernel.log 2> spouse-supervised_pca-kernel.err
python benchmark.py -d spouse-dp -c configs/pca-kernel.json -g configs/top5/cdr-supervised_pca-kernel.json -E 200 > spouse-dp_pca-kernel.log 2> spouse-dp_pca-kernel.err
